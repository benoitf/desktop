...
import { CONSTANT_VALUES} from './contextkey';
import { ContextKeyExpr, implies } from './contextkey';
...
suite('ContextKeyExpr', () => {
  ...
  beforeEach(async () => {
      ...
      CONSTANT_VALUES.set('isLinux', true);
      CONSTANT_VALUES.set('isWindows', false);
    

  });

  // mock values with the same value returned by the getOsPlaform mocked function
