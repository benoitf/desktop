...
export class WebviewPanelImpl implements WebviewPanel {
  ...
  constructor(
    ...
    console.log('creating webview panel', this.#internalId, this.#viewType, this.#title, this.#iconPath);
  }
  ...
  protected assertNotDisposed(): void {
    if (this.#disposed) {
      throw new Error(`The webview panel ${this.viewType} has been disposed.`);
    }
  }
