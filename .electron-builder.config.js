...
console.log('FOOBAR outer loop is set to', process.env.FOOBAR);
console.log('AZURE_KEY_VAULT_URL outer loop is set to', process.env.AZURE_KEY_VAULT_URL);
...
const azureCodeSign = filePath => {
  return new Promise((resolve, reject) => {
    ...
    console.log('FOOBAR inner loop is set to', process.env.FOOBAR);
    console.log('AZURE_KEY_VAULT_URL inner loop is set to', process.env.AZURE_KEY_VAULT_URL);
